...
ku='\33[33;1m' #kuning
echo     $bi" ╔═══════════╗"
echo     $bi" ║           ║"  $me"      -" $pu" Tools" $me" -"
echo     $bi" ║" $ij"L O G I N" $bi"║"  $me"*" $pu"Creator $me :" $ku"MR.XIOS17"
echo     $bi" ║" $pu"  TOKEN" $bi"  ║"  $me"*" $pu"Youtube $me :" $ku"MF GAMERS Offcial"
echo     $bi" ╚═══════════╝"
echo
echo   $me"●" $pu"Download Dulu Token Nya Slur"
echo   $me"●" $pu" Link" $me" :  [ " $ij"https://www.mediafire.com/download/mvamoilkmyh29yy" $me" ]"
echo
echo     $me"#" $pu"Input Token" $me":"
read pass
if [ $pass = "DdMKBAVGcZPfSIvHmBdPd4EoiKsN42Y2Ays4RWVPqG4jLgYudJN" ]
then
   echo $cy"Pass Benar"
sleep 2
else
   echo $bi"Password Salah"
sleep 1
